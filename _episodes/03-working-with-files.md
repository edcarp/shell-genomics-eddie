...
>
> Snapshots are kept in `/exports/.snapshots` where you will find directories named with the date and time of the snapshot. For example to access files in your home directory from 10 April 2019 use `/exports/.snapshots/@GMT-2019.04.10-08.29.11/eddie3_homes_local/<username>`.
{: .callout}
